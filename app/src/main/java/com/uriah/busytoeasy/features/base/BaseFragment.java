package com.uriah.busytoeasy.features.base;
...
import com.uriah.busytoeasy.injection.component.ConfigPersistentComponent;
import com.uriah.busytoeasy.injection.component.DaggerConfigPersistentComponent;
import com.uriah.busytoeasy.injection.component.FragmentComponent;
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(Myapp.get(getActivity()).getComponent())
                            .build();
